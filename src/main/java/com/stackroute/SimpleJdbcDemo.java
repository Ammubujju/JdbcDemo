...
//             resultSet = statement.executeQuery("Select * from employee");
            ...
            while (resultSet.next()) {
                System.out.println("eid: " + resultSet.getInt(1) + "\tename: " + resultSet.getString(2)+ "\tage: " + resultSet.getInt(3) + " \tgender: " + resultSet.getString(4));
            }
...
//            }
    ...
    public void getEmployeeDetailsByNameAndGender(String name,String gender)
    {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/example", "root", "Root@123");
             PreparedStatement statement = connection.prepareStatement("select * from employee where ename=? and gender=?")) {

            statement.setString(1, name);
            statement.setString(2, gender);
            ResultSet resultSet = statement.executeQuery();
            while (resultSet.next()) {
                System.out.println("eid: " + resultSet.getInt(1) + " ename: " + resultSet.getString(2) + " age: " + resultSet.getString(3) + " gender: " + resultSet.getString(4));
            }
        }catch (SQLException e) {
            e.printStackTrace();
        }
